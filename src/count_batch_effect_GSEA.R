...
#fgsea in reactome
read.table("/data/liull/immune-checkpoint-blockade/count_batch_DEG/PD1/PD1_all_DEG.txt",header = T,as.is = TRUE) -> melanoma_PD1_DEG
...
write.table(sig_Reactome,"/data/liull/immune-checkpoint-blockade/count_batch_DEG/PD1/GSEA/PD1_sig_Reactome.txt",quote = FALSE,sep="\t",row.names = FALSE,col.names = TRUE)#
...
ggsave(
  ...
  plot = p,
  device = 'pdf',
  path = '/data/liull/immune-checkpoint-blockade/count_batch_DEG/PD1/GSEA/',
  width = 15,
  height = 8
)
